...
namespace NatML.Vision {
    ...
    public sealed partial class MeetPredictor {
        ...
        public readonly struct Matte {
            ...
            public readonly void Render (RenderTexture destination) {
                // Check texture
                if (!destination)
                ...
                texture.Apply(false);
                // Blit
                renderer = renderer ? renderer : new Material(Shader.Find(@"Hidden/Meet/Blit"));
